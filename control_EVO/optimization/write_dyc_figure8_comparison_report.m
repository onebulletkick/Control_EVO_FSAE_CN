...
localWriteHtmlReport(cfg, metrics, analysisArtifacts, plotManifest, whereFasterAnalysis);
save(cfg.resultMatPath, 'cfg', 'runResults', 'metrics', 'analysisArtifacts', 'plotManifest', 'analysisLines', 'whereFasterAnalysis');
end

function localWriteHtmlReport(cfg, metrics, analysisArtifacts, plotManifest, whereFasterAnalysis)
html = [
    "<!doctype html>"
    "<html lang=""zh-CN"">"
    "<head>"
